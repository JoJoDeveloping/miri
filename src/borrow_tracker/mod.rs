...
pub enum BorrowTrackerMethod {
    ...
    TreeBorrows(tree_borrows::TbConfig),
}
...
impl GlobalStateInner {
    pub fn new_allocation(
        ...
        match self.borrow_tracker_method {
            ...
            BorrowTrackerMethod::TreeBorrows(_config) =>
...
pub trait EvalContextExt<'tcx>: crate::MiriInterpCxExt<'tcx> {
    fn retag_ptr_value(
        ...
        match method {
            ...
            BorrowTrackerMethod::TreeBorrows(config) => this.tb_retag_ptr_value(config, kind, val),
        }
    }
    ...
    fn retag_place_contents(
        ...
        match method {
            ...
            BorrowTrackerMethod::TreeBorrows(config) =>
                this.tb_retag_place_contents(config, kind, place),
        }
    }
    ...
    fn protect_place(&mut self, place: &MPlaceTy<'tcx>) -> InterpResult<'tcx, MPlaceTy<'tcx>> {
        ...
        match method {
            ...
            BorrowTrackerMethod::TreeBorrows(config) => this.tb_protect_place(config, place),
        }
    }
    ...
    fn expose_tag(&self, alloc_id: AllocId, tag: BorTag) -> InterpResult<'tcx> {
        ...
        match method {
            ...
            BorrowTrackerMethod::TreeBorrows(_config) => this.tb_expose_tag(alloc_id, tag),
        }
    }
    ...
    fn print_borrow_state(&mut self, alloc_id: AllocId, show_unnamed: bool) -> InterpResult<'tcx> {
        ...
        match method {
            ...
            BorrowTrackerMethod::TreeBorrows(_config) => this.print_tree(alloc_id, show_unnamed),
        }
    }
